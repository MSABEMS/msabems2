...
ref_smart_plug_3.on("value", function(snapshot) {
    ...
    // console.log(smart_plug_1["CURRENT"])
    document.getElementById("kW_Plug_3").innerHTML = smart_plug_3["CURRENT"].toFixed(2);
...
ref_smart_plug_4.on("value", function(snapshot) {
    ...
    // console.log(smart_plug_1["CURRENT"])
    document.getElementById("kW_Plug_4").innerHTML = smart_plug_4["CURRENT"].toFixed(2);
...
ref_smart_plug_5.on("value", function(snapshot) {
    ...
    // console.log(smart_plug_1["CURRENT"])
    document.getElementById("kW_Plug_5").innerHTML = smart_plug_5["CURRENT"].toFixed(2);
